...
const Sidebar = ({isOpen, toggleSidebar}) => {
  ...
  return (
    <div className={`fixed inset-0 bg-gray-800 p-4 transition-transform md:relative md:translate-x-0 md:w-1/4 md:block ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
            ...
            <div className="max-h-[500px] overflow-y-auto mb-20 md:mb-0 thin-scrollbar">
                {
                   ...
                   <button className="bg-blue-600 text-white text-xl px-3 py-2 rounded-md hover:bg-red-700" 
